...
const CLINIC_DATA: Record<string, any> = {
  ...
  "diet/medicine": { 
    title: "다이어트 한약", 
    subtitle: "체질과 라이프스타일에 맞춘 다양한 맞춤형 다이어트 한약", 
    description: "후한의원 구미점은 환자분의 감량 목표, 체질, 복용 편의성을 모두 고려하여 1:1 맞춤 처방을 진행합니다. 전통적인 탕약부터 복용이 간편한 환, 시럽 형태까지 다양한 솔루션을 제공합니다.", 
    images: ["/images/미감탕.JPG", "/images/다요스틱.JPG", "/images/미감에스.jpg", "/images/다요정.jpg"], 
    features: [
      { title: "미감탕 (전통 탕약)", desc: "개인별 체질에 완벽히 맞춘 1:1 맞춤 탕약으로, 강력한 식욕 억제와 대사량 증진 효과를 제공합니다." },
      { title: "미감스틱 (농축 환)", desc: "고농축 한약을 작은 알갱이(환) 형태로 만들어 휴대와 복용이 간편하며 특유의 향을 최소화했습니다." },
      { title: "미감에스 (시럽형)", desc: "달콤한 맛의 시럽 형태로 한약의 쓴맛에 예민한 분들이나 초보자도 거부감 없이 복용 가능합니다." },
      { title: "다요정 (알약/정제)", desc: "특수 공법으로 압축한 정제 형태로, 일반 알약처럼 물과 함께 가볍게 삼킬 수 있어 일상 중 복용이 매우 편리합니다." }
    ] 
  },
  "diet/program": { 
    title: "다이어트 관리", 
